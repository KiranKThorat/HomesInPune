  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        />
        <span className='text-center text-lg border-neutral-900 text-black'><b>hello, {currentUser.username}</b></span>
        ...
        <input
          ...
          className='border p-3 rounded-lg md:font-bold'
        />
        <input
          type='email'
          placeholder='email'
        ...
        <Link className='bg-blue-400 text-white p-3 rounded-lg uppercase text-center hover:opacity-95' to={"/create-listing"}>
          Create Listing
        </Link>
      </form>
